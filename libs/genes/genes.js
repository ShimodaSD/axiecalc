...
const createBodyPartsDict = () => {
    const bodyPartsDict = {};
    for (let i in bodyPartsList) {
      bodyPartsDict[bodyPartsList[i].partId] = bodyPartsList[i];
    }
    return bodyPartsDict;
};
  
const BODY_PARTS_DICT = createBodyPartsDict();
  
const PATTERN_MAP = {
    "000001": "Fuzzy",
    "000010": "Chess", //(0, 0, 64, 130)
    "000011": "Trispike", //(0, 0, 61, 107)
    "000100": "Triloop", //(0, 0, 82, 74)
    "000101": "Spikes", //(0, 0, 66, 101)
    "000110": "Triarrow", //(0, 0, 51, 134)
    "000111": "Croc", //(0, 0, 57, 117)
    "001000": "Flower", //(0, 0, 59, 67)
    "001001": "Swirl", //(0, 0, 51, 104)
    "001010": "Circles", //(0, 0, 63, 131)
    "001011": "Fishscales", //(0, 0, 73, 153)
    "001100": "Zebra", //(0, 0, 78, 127)
    "001101": "Scales", //(0, 0, 63, 99)
    "001110": "Lines", //(0, 0, 65, 55) - Made this name up
    "011101": "Spiky",
    "011110": "Curly",
    100001: "Wetdog",
    100010: "Sumo",
